defmodule LivrariaPhoenix.DataCase do
  @moduledoc """
  ...
  by setting `use LivrariaPhoenix.DataCase, async: true`, although
  ...
  def setup_sandbox(tags) do
    pid = Ecto.Adapters.SQL.Sandbox.start_owner!(LivrariaPhoenix.Repo, shared: not tags[:async])
